...
@component('student.layout.content-header')
    @slot('title') Sent Box @endslot
    @slot('table_id')mail-list @endslot
        ...
        <div class="card-body p-0">
          <ul class="nav nav-pills flex-column">
            <li class="nav-item active">
              <a href="{{url('student/mailbox')}}" class="nav-link"><i class="fas fa-inbox"></i> Inbox</a>
            </li>
            <li class="nav-item">
              <a href="{{url('student/mailbox/sent')}}" class="nav-link active"><i class="far fa-envelope"></i> Sent Mail</a>
            </li>
          </ul>
        </div>
      </div>
