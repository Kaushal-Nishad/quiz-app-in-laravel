        ...
        <div class="row">
            <div class="col-sm-3">
                <ul style="padding:0;margin:0;list-style:none;">
                    <li><a href="{{url('teacher/mailbox')}}" class="btn btn-secondary" style="width:100%;">Inbox</a></li>
                    <li><a href="{{url('teacher/mailbox/sent')}}" class="btn btn-success" style="width:100%;">Sent Mail</a></li>
                </ul>
            </div>
            <div class="col-sm-9">
