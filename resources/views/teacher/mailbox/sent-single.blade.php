...
@component('teacher.layout.content-header',['breadcrumb'=>['Home'=>'teacher/home','Sentbox'=> 'teacher/mailbox/sent']])
    @slot('title') @endslot
                ...
                <div class="x_panel">
                    ...
                    <div class="media media-chat"> <img class="avatar" src="{{asset('student/default.png')}}" alt="...">
                        <div class="media-body">
                            <h5>{{$mailbox->teacher_name}}</h5>
                            <p>to : {{$mailbox->student_name}}</p>
                    ...
                    <a href="{{url('teacher/mailbox/create?st='.$mailbox->sender_id.'&title='.$mailbox->mail_title)}}" class="btn btn-primary btn-sm"><i class="fa fa-reply"></i> Reply</a>
